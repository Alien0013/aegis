...
_CONSOLIDATION_PROMPT = (
    ...
    "Anti-laziness rules:\n"
    "  - DO NOT skip a merge because the skills have different usage counts. Judge overlap on "
    "what the skills DO (their content/description), not on use_count — 'used 0x' is absence of "
    "evidence either way, not a reason to keep a skill standalone. A rarely-used sibling still "
    "belongs under its umbrella.\n"
