...
```bash
python3 -m pyfiglet "AEGIS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=AEGIS&font=Slant" | boxes -d stone
```
