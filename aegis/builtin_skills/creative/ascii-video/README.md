...
Built for [AEGIS Agent](https://github.com/NousResearch/aegis-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/aegis-agent/skills/creative/ascii-video`](https://github.com/NousResearch/aegis-agent/tree/main/skills/creative/ascii-video) via PR.
