...
SLASH_COMMANDS = (
    ...
    SlashCommand("/v", "discover", "compatibility alias for /version"),
    ...
    SlashCommand("/compose", "discover", "compatibility alias for /prompt in the terminal surface"),
    ...
    SlashCommand("/gateway", "discover", "compatibility alias for /platforms"),
    ...
    SlashCommand("/fork", "sessions", "compatibility alias for /branch", "/fork [title]"),
    SlashCommand("/new", "sessions", "start a fresh session"),
    SlashCommand("/reset", "sessions", "compatibility alias for /new"),
    ...
    SlashCommand("/q", "model control", "compatibility alias for /queue"),
    ...
    SlashCommand("/reload_skills", "model control", "compatibility alias for /reload-skills"),
    SlashCommand("/reload-mcp", "model control", "show MCP reload guidance for the active runtime"),
    SlashCommand("/reload_mcp", "model control", "compatibility alias for /reload-mcp"),
    ...
    SlashCommand("/ts", "display", "compatibility alias for /timestamps", "/ts on|off|status"),
    SlashCommand("/statusbar", "display", "toggle terminal status bar", "/statusbar on|off|status"),
    SlashCommand("/sb", "display", "compatibility alias for /statusbar", "/sb on|off|status"),
    ...
    SlashCommand("/bg", "agents", "compatibility alias for /background", "/bg <prompt>"),
    SlashCommand("/btw", "agents", "compatibility alias for /background", "/btw <prompt>"),
    ...
    SlashCommand("/codex_runtime", "setup", "compatibility alias for /codex-runtime"),
    SlashCommand("/sethome", "setup", "show AEGIS_HOME/profile home guidance"),
    SlashCommand("/set-home", "setup", "compatibility alias for /sethome"),
    ...
    SlashCommand("/snap", "workspace", "compatibility alias for /snapshot"),
    ...
    SlashCommand("/bp", "automation", "compatibility alias for /blueprint"),
    ...
    SlashCommand("/generate-pet", "compatibility", "compatibility alias for /hatch", "/generate-pet [description]"),
    ...
    SlashCommand("/suggest", "compatibility", "compatibility alias for /suggestions"),
...
def _moa_model_specs(config: Any) -> list[str]:
    ...
    early adopters do not lose their setup as this surface converges with the reference behavior.
    """
    raw = None
