...
| aegis skills | list/view/create/install/search/remove/uninstall skills | `aegis skills [-h] [--force] [--json] [--members MEMBERS]                     [--description DESCRIPTION] [--instruction INSTRUCTION]                     [{list,view,new,install,search,remove,uninstall,hub,preview,inspect,browse,check,update,audit,config,opt-in,opt-out,bundles,bundle,unbundle}]                     [name]` |
