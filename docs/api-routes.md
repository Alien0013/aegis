...
| /api/profiles/active | GET | api_profiles_active_get |
| /api/profiles/active | POST | api_profiles_active_post |
| /api/profiles/sessions | GET | api_profiles_sessions |
...
| /api/profiles/{name}/describe-auto | POST | api_profile_describe_auto |
| /api/profiles/{name}/description | PUT | api_profile_description_put |
| /api/profiles/{name}/model | PUT | api_profile_model_put |
| /api/profiles/{name}/open-terminal | POST | api_profile_open_terminal |
| /api/profiles/{name}/setup-command | GET | api_profile_setup_command |
| /api/profiles/{name}/soul | GET | api_profile_soul_get |
| /api/profiles/{name}/soul | PUT | api_profile_soul_put |
...
| /api/skills/content | GET | api_skills_content_get |
| /api/skills/content | PUT | api_skills_content_put |
| /api/skills/hub/install | POST | api_skills_hub_install |
| /api/skills/hub/preview | GET | api_skills_hub_preview |
| /api/skills/hub/scan | GET | api_skills_hub_scan |
| /api/skills/hub/search | GET | api_skills_hub_search |
| /api/skills/hub/sources | GET | api_skills_hub_sources |
| /api/skills/hub/uninstall | POST | api_skills_hub_uninstall |
| /api/skills/hub/update | POST | api_skills_hub_update |
...
| /api/skills/toggle | PUT | api_skills_toggle |
